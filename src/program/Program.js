...
const Program = () => {
    const [sideChange, setSideChange] = useState(document.documentElement.clientWidth < 450);
    useEffect(() => {
        window.addEventListener("resize", () => {
            const side = document.documentElement.clientWidth < 450;
    ...
    return (
        <section className="card program-section middle-section">
